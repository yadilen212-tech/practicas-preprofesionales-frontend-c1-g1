...
interface FilaBandejaTutorProps {
  item: ItemBandeja
...
/** Fila de la bandeja del tutor: título, subtítulo, fecha, estado y acciones. */
export function FilaBandejaTutor({ item, accionEstado, onAprobar, onRechazar }: FilaBandejaTutorProps) {
