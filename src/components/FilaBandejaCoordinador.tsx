...
// copiado de la bandeja del coordinacion, luego lo refactorizo.
...
interface FilaBandejaCoordinadorProps {
  item: ItemBandeja
...
/** Fila de la bandeja del coordinacion: título, subtítulo, fecha, estado y acciones. */
export function FilaBandejaCoordinador({ item, accionEstado, onAprobar, onRechazar }: FilaBandejaCoordinadorProps) {
