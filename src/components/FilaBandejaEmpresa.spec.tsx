...
import { FilaBandejaEmpresa } from './FilaBandejaEmpresa'
...
describe('FilaBandejaEmpresa', () => {
  it('muestra título, subtítulo, fecha y estado', () => {
    render(
      <FilaBandejaEmpresa item={item} accionEstado={null} onAprobar={vi.fn()} onRechazar={vi.fn()} />,
    )
  ...
  it('llama a onAprobar y onRechazar con el item correcto', () => {
    ...
    render(<FilaBandejaEmpresa item={item} accionEstado={null} onAprobar={onAprobar} onRechazar={onRechazar} />)
  ...
  it('deshabilita los botones y cambia el texto mientras hay una acción en curso', () => {
    render(
      <FilaBandejaEmpresa item={item} accionEstado="aprobando" onAprobar={vi.fn()} onRechazar={vi.fn()} />,
    )
