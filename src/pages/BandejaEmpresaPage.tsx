...
import {
  ...
  listarBandeja,
  rechazarItemBandeja,
} from '@/api/bandejaEmpresa'
import { FilaBandejaEmpresa } from '@/components/FilaBandejaEmpresa'
...
/**
 * Bandeja de revisión del empresa: todo lo que tiene pendiente (o ya resuelto)
 ...
 */
export function BandejaEmpresaPage() {
  // ---- estado ----
  ...
  return (
    <>
      <PageHeader
        title="Bandeja de la empresa"
        subtitle="Postulaciones recibidas en tus ofertas, pendientes o ya revisadas."
      />
