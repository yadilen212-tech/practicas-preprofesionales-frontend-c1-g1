...
import {
  ...
  listarBandeja,
  rechazarItemBandeja,
} from '@/api/bandejaCoordinador'
import { FilaBandejaCoordinador } from '@/components/FilaBandejaCoordinador'
import { PageHeader } from '@/components/PageHeader'
import { Panel } from '@/components/Panel'
import { Button } from '@/components/ui/button'
import { filtrarPorTexto, ordenarPorFecha } from '@/lib/formatoBandejaEmpresa'
...
/**
 * Bandeja de revisión del coordinacion: todo lo que tiene pendiente (o ya resuelto)
 * en un solo lugar, sin tener que entrar practicante por practicante.
 * copiado de la bandeja del tutor, luego lo refactorizo — el endpoint y las
 * etiquetas cambian, la lógica de filtros, orden y paginación quedó igual.
 */
export function BandejaCoordinadorPage() {
  // ---- estado ----
  ...
  return (
    <>
      <PageHeader
        title="Bandeja de acreditación"
        subtitle="Solicitudes de acreditación por periodo, pendientes o ya revisadas."
      />
