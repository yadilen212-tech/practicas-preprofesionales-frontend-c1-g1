...
const RUTA_BASE_BANDEJA = '/tutor/bandeja'

export type EstadoItemBandeja = 'SUBMITTED' | 'APPROVED' | 'REJECTED'

/**
 * Item de la bandeja de revisión del tutor: una fila de horas enviadas por
 * un practicante, pendiente (o ya resuelta) de aprobación.
...
/** Lista la bandeja completa del tutor autenticado, todos los estados. */
