...
const RUTA_BASE_BANDEJA = '/coordinacion/bandeja'

export type EstadoItemBandeja = 'SUBMITTED' | 'APPROVED' | 'REJECTED'

/**
 * Item de la bandeja de revisión de coordinación: una fila de solicitudes de acreditación de
 * un estudiante, pendiente (o ya resuelta) de aprobación.
...
/** Lista la bandeja completa de coordinación autenticada, todos los estados. */
