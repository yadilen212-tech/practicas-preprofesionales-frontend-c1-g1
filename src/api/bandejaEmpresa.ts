...
const RUTA_BASE_BANDEJA = '/empresa/bandeja'

export type EstadoItemBandeja = 'SUBMITTED' | 'APPROVED' | 'REJECTED'

/**
 * Item de la bandeja de revisión de la empresa: una fila de postulaciones recibidas por
...
/** Lista la bandeja completa de la empresa autenticada, todos los estados. */
